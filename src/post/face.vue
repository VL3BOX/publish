    ...
    <div class="m-publish-box m-publish-box-face" v-loading="loading">
        ...
        <el-form label-position="left" label-width="90px">
            ...
            <div class="m-publish-info">
                ...
                <!-- 自动解析 -->
                <!-- 体型 -->
                <el-form-item :label="$t('体型')" v-if="faceData">
                ...
                <!-- 画风 -->
                <el-form-item :label="$t('画风')" v-if="faceData && post.client === 'std'">
                ...
                <!-- 可新建 -->
                <el-form-item v-if="faceData" :label="$t('可新建')">
                ...
                <el-form-item>
                    <template #label>
                        <span>{{ $t('价格') }}</span>
                        <el-tooltip :content="$t('仅签约作者可以发布收费作品；1金箔=1分CNY')">
                    ...
                    <el-radio-group v-model="post.price_type" :disabled="!isSuperAuthor" @change="changePriceType">
                        ...
                        <el-radio v-if="isSuperAuthor && cny_enable" label="2">{{ $t('收费(金箔)') }}</el-radio>
                    </el-radio-group>
                    <el-input-number
                        class="u-price"
                ...
                <el-form-item :label="$t('说明')">
                    <el-input v-model="post.remark" :placeholder="$t('请填写相关说明')" type="textarea" :rows="3"></el-input>
                </el-form-item>
